    ...
    <div className="col-xl-2 col-md-4 col-sm-6 p-2 mb-4" style={{ maxHeight: "500px" }}>
      <div className="card h-100 border-0">
        ...
        <Link to={`/movie/${movie.id}`}>
          <img
            src={movie.backdrop_path ? `https://image.tmdb.org/t/p/w500${movie.backdrop_path}` : movie.poster_path ? `https://image.tmdb.org/t/p/w500${movie.poster_path}`: "https://placehold.co/500x750?text=No+Image" }
